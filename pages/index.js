...
const styles = {
  ...
  buyingPowerContainer:
    'w-full norder-t mb-24 border-b h-16 border-[#30363b] flex justify-between',
  ...
  itemTitle: 'cursor-pointer text-xl',
  moreOptions: '',
}
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.rightMain}>
          ...
          {/* Map thourh coins and for every coin make an asset components */}
          {/* <Asset /> */}
          <div className={styles.rightMainItem}>
